...
namespace WPAppStudio.Repositories
{
    ...
    public class Youtube_Youtube : IYoutube_Youtube 
    {
		...
		private const string YoutubeQuery = @"xHDxSHIPPUDEN";

        /// <summary>
        /// Initializes a new instance of the <see cref="Youtube_Youtube" /> class.
        /// </summary>
        /// <param name="youtubeDataSource">A Youtube data source.</param>
		/// <param name="internetService">Internet service.</param>
        /// <param name="storageService">Storage service.</param>
        public Youtube_Youtube(RepositoriesBase.IYoutubeDataSource youtubeDataSource, IServices.IInternetService internetService, IServices.IStorageService storageService)
        {
        ...
        /// <summary>
        /// Retrieves the data from Youtube (channel: xHDxSHIPPUDEN ), in an observable collection of YouTubeVideo items.
        /// </summary>
        ...
        /// <summary>
        /// Refresh the data from Youtube (channel: xHDxSHIPPUDEN ), in an observable collection of YouTubeVideo items.
        /// </summary>
        /// <returns>An observable collection of YouTubeVideo items.</returns>
		...
		/// <summary>
        /// Retrieves the data from Youtube (channel: xHDxSHIPPUDEN ), filtered by a filter specification, in an observable collection of YouTubeVideo items.
        /// </summary>
        ...
        {
			var data = _storageService.Load<ObservableCollection<EntitiesBase.YouTubeVideo>>("Youtube_Youtube");
        ...
        {
			var storedItems = _storageService.Load<ObservableCollection<EntitiesBase.YouTubeVideo>>("Youtube_Youtube");
            ...
            if (_internetService.IsNetworkAvailable() && (pageNotSaved || forceRecaching))
            {
                ...
                if(newItems != null && newItems.Any())
				{
					...
					_storageService.Save("Youtube_Youtube", new ObservableCollection<EntitiesBase.YouTubeVideo>(storedCollection));
				}
			}

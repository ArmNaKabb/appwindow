...
namespace WPAppStudio.ViewModel
{
    ...
    {       
        ...
        {
			_title = @"NaRuTo";
			_description = @"Naruto (ナルト?) is an ongoing Japanese manga series written and illustrated by Masashi Kishimoto. The plot tells the story of Naruto Uzumaki, an adolescent ninja who constantly searches for recognition and dreams to become the Hokage, the ninja in his villa"; 
			_version = "v1";
			_appLink = "https://apps.windowsstore.com/DashBoard/DownloadAppXap?appId=aadf4b04-9e2e-4a07-9689-25d4745c2c93";
